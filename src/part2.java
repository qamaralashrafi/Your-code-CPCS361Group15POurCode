...
public class part2 {
    ...
    public static int quantum = 10+15;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        {
            ...
            write = new PrintWriter("PT2outputnew4.txt");
...
//remove running process from CPU and add new job to CPU
    ...
    public static void internalEvent() throws FileNotFoundException {
        ...
        if (exeJob != null) {
            ...
            if (exeJob.getremainingTime() <= 0) { //job is done processing

                CPUrelease();

                //Check if we can alloate an processes from hol queues to ready queues
                toReadyQueue(null);
                ...
                if (!ReadyQueue.isEmpty()) {
                    ...
                    if (exeJob.getremainingTime() > 0) {
                        Traditional_Round_Robin(exeJob);
                    }
                    */
                }
...
////////////////////////////////////////////////////////////////////////////////////////////
//send job from hold queue to ready queue
    public static void toReadyQueue(Job j) {
        if (j == null) {
            ...
            if (avbMemory >= j.getRequestedMemory() && avbDevices >= j.getRequestedDevices()) {
                ReadyQueue.add(j);
...
////////////////////////////////////////////////////////////////////////////////////////////
//execute traditional round robin
    public static void Traditional_Round_Robin(Job P) {
        ...
        //ComputeAvgBT();
            ...
            // Set the executing job finish time
            int finish = Math.min(exeJob.getremainingTime(), quantum);
            //exeJob.setremainingTime(exeJob.getremainingTime() - finish);
            exeJob.setFinishTime(currentTime + finish);
            // Update SR & AR
            ComputeAvgBT();
            ...
            if (exeJob.getremainingTime() > 0) {
                ...
                exeJob.setremainingTime(exeJob.getburstTime() - finish);
                exeJob.setburstTime(exeJob.getremainingTime());
                ReadyQueue.add(exeJob);
        //ComputeAvgBT();
            }
        }
